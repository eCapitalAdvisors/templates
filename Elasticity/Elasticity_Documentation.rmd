...
If the good is inelastic, then |$\beta\$| < 1. This means that if the price were to increase, the revenue for the firm is likely to increase.

If the good is elastic, then |$\beta\$| > 1. This means that if the price were to increase, the revenue for the firm is likely to decrease.

If the good is unitary elastic, then |$\beta\$| = 1. This means the regardless of the price, the revenue is likely to stay relatively the same.
...
In this model, the price is inelastic (1.1653472 > 1). This means that if the price were to increase, the revenue for the firm is likely to decrease.
...
For example, iPhone and Andriod Phones.

If cross elasticity is negative, the goods are complimentary. This means that the demand for good A will increase as the price of good B decreases.
...
If absolute value of price elasticity of supply > 1, the supply is elastic. This means that the good is luxury; thus, an increase in price correlates to a decrease in consumption. 
For example, movie tickets.

If absolute value of price elasticity of supply < 1, the supply is inelastic. This means that the good is a necessity; thus, an increase in price does not correlate to a significant change in quantity demanded.
For example, gas.

If absolute value of price elasticity of supply = 1, the supply is vertical. This means that there is no response to prices.
