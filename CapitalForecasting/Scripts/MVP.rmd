...
The following graphs show three year forecasts for working capital levels. The first simulated five different paths working capital could take, while the second shows the expected path and the probability range around it.
